...
export default function Logo({ variant = "horizontal", className = "", light = false }: LogoProps) {
  ...
  const renderIcon = (sizeClass: string) => (
    ...
    >
      ...
      <line x1="68" y1="28" x2="75" y2="21" stroke="#E15500" strokeWidth="5.5" strokeLinecap="round" />
      <line x1="60" y1="32" x2="69" y2="30" stroke="#E15500" strokeWidth="5.5" strokeLinecap="round" />
      <line x1="62" y1="39" x2="70" y2="41" stroke="#E15500" strokeWidth="5.5" strokeLinecap="round" />
      ...
      <ellipse cx="53" cy="45" rx="3" ry="4.5" fill="#E15500" />
