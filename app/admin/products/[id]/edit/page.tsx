    ...
    <div className="admin-dark min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="border-b border-slate-800 pb-4">
          ...
          <p className="text-xs text-slate-400 mt-1">Modify product details, prices, keywords, and affiliate networks</p>
        </div>
        ...
        <form action={updateProduct} className="space-y-6 bg-slate-900/40 border border-slate-850 p-6 rounded-2xl">
          ...
          <div className="space-y-1.5">
            ...
            <ImageUploadInput defaultValue={product.image} name="image" />
          </div>
